...
This can be found on the benchmark dir
  ...
  Benchmark.bm do |x|
    x.report("Simple") do 
      n.times { One40Proof::Simple::Test.new }
    end
    x.report("Multi") do
      query = []
...
To get an ad for a specific user
  ...
  ad = One40Proof::Simple::UserAd.new(:user_id => 'reddavis', :app_id => 'your app_id')
...
To get an ad for a specific query
  ...
  ad = One40Proof::Simple::Search.new(:user_id => 'reddavis', :app_id => 'your app_id', :q => 'magic hats')
